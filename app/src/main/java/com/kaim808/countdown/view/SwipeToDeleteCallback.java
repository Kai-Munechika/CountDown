...
public class SwipeToDeleteCallback extends ItemTouchHelper.SimpleCallback {
    ...
    public SwipeToDeleteCallback(ItemAdapter adapter) {
        ...
        itemAdapter = adapter;
        icon = ContextCompat.getDrawable(itemAdapter.getContext(), R.drawable.ic_delete);
        background = new ColorDrawable(adapter.getContext().getResources().getColor(R.color.colorAccent, adapter.getContext().getTheme()));
    }
